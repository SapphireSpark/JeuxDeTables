...
class MarshallerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->resourceTypes = $this->getTableLocator()->get('Comments');
        $this->users = $this->getTableLocator()->get('Users');
        $this->tags = $this->getTableLocator()->get('Tags');
        $this->articleTags = $this->getTableLocator()->get('ArticlesTags');

        $this->resourceTypes->belongsTo('Articles');
        $this->resourceTypes->belongsTo('Users');

        $this->articles->setEntityClass(__NAMESPACE__ . '\OpenEntity');
        $this->resourceTypes->setEntityClass(__NAMESPACE__ . '\OpenEntity');
    ...
    public function tearDown()
    {
        ...
        unset($this->articles, $this->resourceTypes, $this->users, $this->tags);
    }
    ...
    public function testOneWithDatetimeField()
    {
        ...
        $marshall = new Marshaller($this->resourceTypes);
        $result = $marshall->one($data, []);
    ...
    public function testOneBelongsToManyWithNestedAssociations()
    {
        ...
        $this->assertNotEmpty($tag->articles[0]->resourceTypes);
        $this->assertCount(2, $tag->articles[0]->resourceTypes);
        $this->assertTrue($tag->articles[0]->isDirty('comments'), 'Updated prop should be dirty');
        $this->assertInstanceOf('Cake\ORM\Entity', $tag->articles[0]->resourceTypes[0]);
        $this->assertTrue($tag->articles[0]->resourceTypes[0]->isNew());
        $this->assertTrue($tag->articles[0]->resourceTypes[1]->isNew());
    }
    ...
    public function testOneHasManyWithIds()
    {
        ...
        $this->assertEquals($article->comments[0], $this->resourceTypes->get(1));
        $this->assertEquals($article->comments[1], $this->resourceTypes->get(2));
    }
    ...
    public function testMergeManyExistingQueryAliases()
    {
        ...
        $this->resourceTypes->getEventManager()->on('Model.beforeFind', function (Event $event, $query) {
